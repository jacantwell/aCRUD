...
from acrud import create_storage, S3StorageConfig

s3_config = S3StorageConfig(bucket="tl-workflows")
...
class TestS3Storage:
    @pytest.fixture
    def root_dir(self):
        """Create a S3Storage instance with a temporary root directory."""
        return os.getcwd()
